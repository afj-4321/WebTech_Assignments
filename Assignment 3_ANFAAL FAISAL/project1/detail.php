                ...
                <div class="row">
                    ...
                    <?php   /* you will need to replace this hard-coded data with appropriate PHP */ 
                        ...
                        echo "<div class=\"col-md-8\">
                            <img class=\"img-responsive\" src=\"images/medium/".$a['path']."\" alt=\"".$a["title"]."\">
                        ...
                        echo "<h2>".$a["title"]."</h2>
                                ...
                                <li>By: <a href=\"#\">".$a["user"]."</a></li>
                                <li>Country: <a href=\"#\">".$a["country"]."</a></li>
                                <li>City: <a href=\"#\">".$a["city"]."</a></li>
                                <li>Taken on: ".$a["taken"]."</li>
                                </ul></div></div>";
                        /*Button Group*/
                        $buttonType=array("heart","save","print","comment");
                        echo    "<div class=\"btn-group btn-group-justified\" role=\"group\" aria-label=\"...\">";
                        for($i=0;$i<count($buttonType);$i++){
                            echo    "<div class=\"btn-group\" role=\"group\">
                                <button type=\"button\" class=\"btn btn-default\"><span class=\"glyphicon glyphicon-".$buttonType[$i]."\" aria-hidden=\"true\">
                                </span></button>
                                </div>";
                        }
                        echo    "</div>";
                        ...
                        for($i=0;$i<count($a["tags"]);$i++){
                            echo '<span class="label label-default">'.$a["tags"][$i].'</span>';
                        }
                        echo "</div>
                            </div>
                            </div>";
